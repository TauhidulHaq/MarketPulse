          ...
          {!selectedProduct ? (
              ...
              {products.map((product) => (
                <div key={product._id} className="bg-gray-200/50 p-4 rounded-3xl flex items-center justify-between border border-transparent hover:border-emerald-200 transition-all">
                  <div className="flex items-center gap-6">
                    ...
                    <div className="w-24 h-16 bg-white rounded-2xl shadow-sm border border-gray-100"></div>
                  </div>
                  <button 
            ...
            <div className="animate-fade-in space-y-8">
              <button 
                ...
                className="text-primary-600 font-bold text-sm flex items-center gap-2 hover:underline"
              >
                ← Back to Selection
              </button>
              ...
              <div className="grid grid-cols-2 gap-8">
                ...
                <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 flex items-center justify-between">
                  <div>
                    ...
                    <div className="bg-gray-200/60 px-10 py-2 rounded-2xl text-emerald-500 font-bold text-lg inline-block">
              ...
              <div className="grid grid-cols-2 gap-8">
                ...
                <SummaryCard 
                   ...
                   subtitle="The product is performing optimally in campaign sales"
                ...
                <SummaryCard 
                   ...
                   subtitle="The product is performing optimally in other sales"
                   icon={<span className="text-primary-600">💵</span>}
                />
              </div>
            </div>
